...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume",   function () awful.util.spawn("pactl set-sink-volume @DEFAULT_SINK@ +3000") end),
    awful.key({}, "XF86AudioLowerVolume",   function () awful.util.spawn("pactl set-sink-volume @DEFAULT_SINK@ -3000") end),
    -- Webcam
    awful.key({ modkey, "Control"}, "w",   function () awful.util.spawn("webcam show") end),
